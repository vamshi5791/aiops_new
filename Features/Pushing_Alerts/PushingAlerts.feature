...
Feature: Pushing Alerts through RabbitMQ
  ...
  Scenario Outline: Pushing Alerts through RabbitMQ
    ...
    Examples:
      ...
      | admin         | j5c6ym6nFm8M2Yia  | Itops_admin    | qa123          | Automation_M3 | 1.1518.Automation_M3.exchange | 1.1518.Channel600.queue | 1.1518.Channel600.queue | AlertName01 | Demo          | Sample     |

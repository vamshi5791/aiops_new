...
Feature: Login persona functionalities of Installation Engineer
        ...
        Scenario: Installation Engineer is unable to  view Infrastructure
              When "Installation_Engineer" opens infrastructure page

...
Feature Description : Device Inventory Features
    ...
    # | Itops_admin    | qa123          | Automation_02 | Automation_02   |
        ...
        Examples:
                  ...
                  | Itops_admin    | qa123          | Automation_02 | Automation_02   | AUSYCT-28A-SBC2 | ausyct-28a-sbc1 |
...
#     Examples:
#         | Itops_UserName | Itops_Password | projectName   | TestProjectName | DeviceName      | Device          |
#         | Itops_admin    | qa123          | Automation_02 | Automation_02   | AUSYCT-28A-SBC1 | ausyct-28a-sbc1 |


# @Delete_Topology
# Scenario Outline: Delete_Topology View

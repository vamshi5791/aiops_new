...
Feature:  Advanced Filters
    ...
    Scenario Outline: Verify user able to select values from incident drop down in advanced filters
        ...
        Examples:
            | UserName    | Password | ProjectName      | AdvancedFilters  | SourceAndResource    | StateAndStatus   | DataAndTime   | Alert_State | Alert_State2 | Alert_State3 | Alert_State4 |
            | Itops_admin | qa123    | Automation_IB_24 | Advanced Filters | Source and Resources | State and Status | Date and Time | Open        | Assigned     | On Hold      | Closed       |

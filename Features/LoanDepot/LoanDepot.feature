...
Feature: Loan Depot
    ...
    Scenario Outline: Verify that Business Timezone/Data source/Data point fields will have data to ES if they are pushed with Alert
        ...
        And Admin gets the alertId
        And "Admin" verifies the DataPoint response in alert console "<ProjectId>"
        And "Admin" verifies the data source data in alert console "<ProjectId>"
        And "Admin" verifies the business Time Zone in alert console "<ProjectId>"

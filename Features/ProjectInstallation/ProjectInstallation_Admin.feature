...
Feature: Project Installation with ITOps Admin role
     ...
     Scenario Outline: Project Creation
          ...
          Examples:
               ...
               | Itops_admin | qa123    | Automation_IB_90 | Release1.4Project | Project Created Successfully |
     ...
     Scenario Outline: General Configuration
          ...
          Examples:
               ...
               | https://ustglobaldev.service-now.com | ustglobal          | 1234                | 01.00          | USTTestITSM | 1.01        | IST          | AIOps Desk  | Project Configurations Updated |

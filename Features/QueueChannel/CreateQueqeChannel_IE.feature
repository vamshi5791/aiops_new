@CreateQueueChannel_IE @ITOps_Milestone_1
Feature: Create Queue Channel Itops Admin role
    ...
    Scenario Outline: Verify Queue Channel creation
        ...
        When "IE" enters project name in project search feild
        ...
        Examples:
            | UserName | Password | QueueChannelName |
            | Itops_IE | qa123    | TestIEChannell   |
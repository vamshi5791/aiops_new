...
When('Installation Engineer Creates Queue Channel {string}, {string}, {string}, {string}, {string}', async function (username, password, channelName, projectID, projectName) { 
...
// When('Installation Engineer click dotmenu icon', async function () {
//   await objProjectListing.DotMenu();
// });
When('Installation Engineer click dotmenu icon {string}', async function (ProjectName) {
  // await objProjectListing.DotMenu();
  await objProjectListing.ThreeDots(ProjectName);
});

When('Installation Engineer click editProject', async function () {
